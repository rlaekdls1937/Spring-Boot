package com.kimdain.basic.config;
...
import com.kimdain.basic.filter.JwtAuthenticationFilter;
import com.kimdain.basic.provider.OAuth2SuccessHandler;
...
public class WebSecurityConfig {
    ...
    protected SecurityFilterChain configure(HttpSecurity security) throws Exception{
        ...
        // - 용도 : cookie에는 간단한 데이터(id token)를 저장, session에넌 민감한 데이터(개인정보)를 저장
        ...
        // OAuth 인증 서버에서 redirection 하는 URL 지정
            ...
            // OAuth 인증 서버에서 인증 철차가 끝난 후 사용자에 대한 정보를 처리하는 객체를 지정
